...
//                 sh """
//                 aws s3 cp s3://alankruthiart/application/${buildno}/hello-${buildno}.war
//                 """
//             }
//         }
...
//                 sh "scp -o StrictHostKeyChecking=no -i /tmp/alankruthi21.pem hello-${buildno}.war ec2-user@${ssererip}:/tmp"
